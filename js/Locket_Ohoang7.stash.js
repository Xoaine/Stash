// Locket Premium Unlock - Stash Rewrite
...
if (typeof $response !== "undefined") {
  ...
  if (match) {
    let [entitlement, subName] = mapping[match];
    if (subName) {
      vuong2023.product_identifier = subName;
      obj.subscriber.subscriptions[subName] = ohoang7;
    } else {
